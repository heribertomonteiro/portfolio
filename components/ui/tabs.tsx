...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "group/tabs flex gap-2 data-horizontal:flex-col xl:data-horizontal:flex-row ",
        className
      )}
      {...props}
    />
...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-full l:w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
